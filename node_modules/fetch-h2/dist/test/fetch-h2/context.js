    ...
    describe(`context (${version} over ${proto.replace(":", "")})`, () => {
            ...
            describe("network settings", () => {
                it("should not be able to connect over unauthorized ssl", async () => {
                    ...
                    try {
                        ...
                        expect(err.message.includes("closed") // < Node 9.4
                            ||
                                err.message.includes("self signed") // >= Node 9.4
                            ||
                                err.message.includes("expired")).toBeTruthy();
                    }
                    disconnectAll();
                    await server.shutdown();
                });
        ...
        describe("cookies", () => {
            it("should be able to specify custom cookie jar", async () => {
                ...
                const cookies = await cookieJar.getCookies(`${proto}//localhost:${port}/`);
                ...
                const cookies2 = await cookieJar.getCookies(`${proto}//localhost:${port}/`);
                ...
                cookieJar.reset();
                await fetch(`${proto}//localhost:${port}/echo`);
                const cookies3 = await cookieJar.getCookies(`${proto}//localhost:${port}/`);
