...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield postComment(deployment, githubToken);
        }
        catch (error) {
...
function deploy(folder, token, options) {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (var _b = __asyncValues(now.createDeployment(folder, Object.assign({ token }, options))), _c; _c = yield _b.next(), !_c.done;) {
...
function postComment(body, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield octokit.issues.createComment(Object.assign({}, github.context.issue, { body }));
    });
}
run();
